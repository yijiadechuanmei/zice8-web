...
const activityTypeProjects = {
  ...
  maotai_c_create_fun_20260923: MaotaiCCreateFunProject,
  tianfu_new_district_reading_20260927: TianfuNewDistrictReadingProject,
}
...
export const projectRoutes = [
  ...
  {
    path: '/rider-safety-survey/:activityKey',
    Component: RiderSafetySurveyProject,
  },
  {
    path: '/longwen-beer-quiz/:activityKey',
    Component: LongwenBeerQuizProject,
    activityGate: true,
  },
  {
    path: '/longwen_beer_quiz/:activityKey',
    Component: LongwenBeerQuizProject,
    activityGate: true,
  },
  {
