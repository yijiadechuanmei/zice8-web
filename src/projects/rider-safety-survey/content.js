...
export const results = {
  road_ceiling: {
    ...
    comment:
      "哥/姐，您这安全意识简直刻进DNA了！靠边停车比驾校教练还标准，分得清职伤和商保，骗子见了您都得绕道走。您不是来跑单的，您是来给站点当安全总顾问的！",
    advice:
      "别光自己牛，带带旁边那个单手骑车的新手，站长给您申请“以老带新”补贴！",
  },
  veteran_driver: {
    title: "油门焊死·老司机",
    stars: 4,
    ...
    comment:
      "车技这块您拿捏得死死的，下雨天滑倒都知道怎么拍照留证，绝对是老江湖！但一问职伤保障就“马冬梅”——国家给交的保险不要白不要，更别信“代办多赔钱”的中介。",
    advice: "省下找中介的抽成钱，够加俩鸡腿了。下回培训课听5分钟，保命又省钱！",
  },
  wallet_guardian: {
    title: "钱包守护神",
    stars: 4,
    ...
    comment:
      "刷单、假理赔、征信修复……您一眼看穿，这觉悟不去搞反诈宣传都屈才了！但骗子的钱骗不走，马路牙子也可能“骗”走你的腿。福建职伤险是专属福利，别让“懒得看”耽误报销。",
    advice: "把反诈的脑子分一半给交通安全，您就是完美骑手。",
  },
  rising_flyer: {
    title: "升级中的小飞侠",
    stars: 1,
    ...
    comment:
      "新人吧？别光顾着低头跑！靠边停车不丢人，摔了才误单；万一碰了，先拍照再报警。平台给你的职伤险是护身符，别当废纸扔了。",
    advice: "跑单前三天，先把这张诊断书截屏存手机，比求神仙保佑管用！",
  },
  zen_rider: {
    title: "看淡一切·躺平侠",
    stars: 2,
  ...
  hesitation_loses: {
    ...
    comment:
      "一听“中介代办多赔钱”就心动？醒醒！正规理赔不收一分钱。找中介不仅可能被抽走赔款，还可能因虚构材料把自己送进去。关键时刻，千万别犯迷糊。",
    advice: "贪小便宜吃大亏，官方客服电话存好了，犹豫时候打一个。",
  },
};
