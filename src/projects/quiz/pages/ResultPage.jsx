    ...
    <main className="quiz-page flex min-h-screen w-full justify-center bg-[#143978] pb-7">
      <section className="w-full max-w-[750px]">
        <DesignStage height={1624}>
          ...
          <div className="absolute left-[152px] top-[492px] w-[444px] text-center text-[42px] font-black text-[#173f2a]">
            {result?.totalScore ?? 0} 分
          </div>
          <div className="absolute left-[152px] top-[702px] w-[444px] text-center text-[42px] font-black text-[#173f2a]">
