  ...
  return (
    <main className="lyfg-page lyfg-ih5-page lyfg-ih5-rules-page">
      <Ih5Stage label="合成水果规则">
        ...
        <button className="lyfg-ih5-action lyfg-ih5-rules-back" type="button" onClick={onStart} aria-label="开始合成水果游戏">
          <PosterImage asset="mergeRulesBack" className="lyfg-ih5-fill-image" alt="开始游戏" />
        </button>
