...
const GAMES = [
  { background: 'spotGameBackgroundA', title: 'spotGameTitleA', top: 'spotGame1Top', bottom: 'spotGame1Bottom', topBox: [11, 109, 730, 619], bottomBox: [11, 735, 729, 619], spots: [
    ['268e1f43ec71891eca7a4cbd70bfa72d_8018_238_159.png', 164, 112, 238, 159, 738], ['3cbe11be4655a6b6996fc3f24ae78660_6681_141_141.png', 427, 162, 141, 141, 788], ['11f9eecf26f2c3ae8758611a60476efd_5907_117_117.png', 370, 473, 117, 117, 1100], ['11f9eecf26f2c3ae8758611a60476efd_5907_117_117.png', 592, 311, 117, 117, 937], ['640a234bb66c83aecc1e9e4ce76d9029_7075_154_154.png', 518, 534, 154, 154, 1160], ['11f9eecf26f2c3ae8758611a60476efd_5907_117_117.png', 265, 386, 117, 117, 1009],
  ] },
  { background: 'spotGameBackgroundB', title: 'spotGameTitleB', top: 'spotGame2Top', bottom: 'spotGame2Bottom', fullCanvas: true, titleBox: [150, 118, 459, 68], hintBox: [178, 1445, 384, 59], topBox: [10, 207, 731, 600], bottomBox: [9, 820, 732, 603], spots: [
    ['f32cd7423052dc03eec144d2f86dd84e_6757_146_146.png', 77, 337, 146, 146, 955], ['be993c271a8b8b094f100eb9237386af_6390_133_133.png', 207, 649, 133, 133, 1267], ['be993c271a8b8b094f100eb9237386af_6390_133_133.png', 251, 414, 133, 133, 1032], ['5ea09cd8d4f6ad57571122e8cf776c37_6365_132_132.png', 591, 265, 132, 132, 883], ['ab2d4685e82e9b156bc26ae4f31755a8_6753_226_109.png', 204, 232, 226, 109, 850], ['be993c271a8b8b094f100eb9237386af_6390_133_133.png', 453, 236, 133, 133, 844],
  ] },
...
export default function SpotDifferenceFindGame({ onBack, onComplete }) {
  ...
  const complete = found.length >= TARGET_COUNT
  useEffect(() => {
  ...
  return <main className={`lyfg-page lyfg-ih5-page lyfg-spot-find-page${game.fullCanvas ? ' lyfg-spot-find-page--full' : ''}`}><Ih5Stage label="乡韵怀旧找茬">
    <Image asset={game.background} className="lyfg-ih5-background" />
    <Image asset={game.title} className="lyfg-spot-find-title" style={game.titleBox ? boxStyle(game.titleBox) : undefined} alt="乡韵怀旧找茬" />
    ...
    <Image asset="spotGameHint" className="lyfg-spot-find-hint" style={game.hintBox ? boxStyle(game.hintBox) : undefined} alt="找出不同之处" />
    <button className="lyfg-spot-find-back" type="button" onClick={onBack} aria-label="返回找茬规则">‹</button>
    <div className="lyfg-spot-find-count">已找到 <b>{Math.min(found.length, TARGET_COUNT)}</b> / {TARGET_COUNT}</div>
