...
import { GameRulesModal } from './GameSelector'
  ...
  return (
    <main className="lyfg-page lyfg-ih5-page lyfg-ih5-home-page">
      <Ih5Stage label="绿园消保 硕果盈心">
        ...
        <button className="lyfg-ih5-action lyfg-ih5-home-ranking" type="button" onClick={() => setShowRules(true)} aria-label="查看游戏规则">
          <PosterImage asset="selectorRules" className="lyfg-ih5-fill-image" alt="游戏规则介绍" />
        </button>
