...
export default function GameSelector({ onComingSoon, onSelectFruitMerge }) {
  return (
    <main className="lyfg-page lyfg-ih5-page lyfg-ih5-selector-page">
      <Ih5Stage label="游戏选择">
        ...
        <button className="lyfg-ih5-action lyfg-ih5-game-card lyfg-ih5-game-card--snake" type="button" onClick={onComingSoon} aria-label="贪吃蛇，敬请期待">
          <PosterImage asset="selectorSnake" className="lyfg-ih5-fill-image" alt="贪吃蛇，敬请期待" />
        </button>
