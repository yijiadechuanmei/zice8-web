  ...
  return (
    <article className="nh-rules-content" aria-label="活动规则">
      ...
      <section>
        <h2>答题闯关流程</h2>
        <ol>
          <li><div>用户进入活动页面后，点击「开始答题」即可参与闯关，全程共10道工伤预防基础知识选择题。</div></li>
          <li><div>题目覆盖五大核心场景，贴合日常工作与生活场景，无答题时间限制，可仔细阅读题目后作答。</div></li>
          <li><div>逐题完成作答，依次答完全部10道题目，即可完成闯关，系统自动判定闯关成功。</div></li>
        </ol>
      </section>
      <section>
        <h2>抽奖资格说明</h2>
      ...
      <section>
        <h2>发放须知</h2>
        <ol>
          <li><div>本次游戏是随机发放，抽奖成功后将自动发放至用户微信账户。</div></li>
          <li><div>用户可通过微信服务账单、微信零钱明细查询到账情况，无需额外操作领取。</div></li>
          <li><div>若出现发放延迟到账、发放异常等问题，可稍后重新查看，系统将统一补发处理。</div></li>
        </ol>
      </section>
    </article>
  )
