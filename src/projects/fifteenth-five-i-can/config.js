...
export const PUBLIC_ACTIVITY_DATA = {
  ...
  questions: [
    { no: 1, type: "single", title: "中汽中心“十五五”确立的发展战略简称是", options: [{ id: "A", text: "“一四二三”" }, { id: "B", text: "“一二三四”" }, { id: "C", text: "“五二五”" }, { id: "D", text: "“二五二”" }], correctOptions: ["A"] },
    { no: 2, type: "multiple", title: "中汽中心的核心功能有哪些？", options: [{ id: "A", text: "汽车产业标准创新引领" }, { id: "B", text: "汽车产业战略政策支撑" }, { id: "C", text: "汽车行业共性技术供给" }, { id: "D", text: "汽车产品价值提升促进" }], correctOptions: ["A", "B", "C", "D"] },
    { no: 3, type: "multiple", title: "中汽中心的核心竞争力有哪些？", options: [{ id: "A", text: "全价值链技术服务能力" }, { id: "B", text: "前瞻科技策源创新能力" }, { id: "C", text: "基础资源建设整合能力" }, { id: "D", text: "产业生态构建协同能力" }], correctOptions: ["A", "B", "C", "D"] },
    { no: 4, type: "multiple", title: "中汽中心“十五五”规划中“两聚焦两着力”指的是什么？", options: [{ id: "A", text: "聚焦战略使命和高质量发展的内生需求，着力增强汽车全价值链协同效能" }, { id: "B", text: "聚焦创新驱动可持续发展的根本要求，着力培育新质发展动能" }, { id: "C", text: "聚焦产业变革和市场竞争的现实需要，着力扩大传统业务规模优势" }, { id: "D", text: "聚焦年度经营目标和考核激励的刚性约束，着力提升短期经营效益" }], correctOptions: ["A", "B"] },
    { no: 5, type: "single", title: "下列不属于十五五期间的发展布局的有：", options: [{ id: "A", text: "“1+9+X”新业务布局" }, { id: "B", text: "“一体三基四协同”新业务布局" }, { id: "C", text: "国内区域协同的新网络化布局" }, { id: "D", text: "赋能汽车产业走出去的新国际化布局" }], correctOptions: ["B"], explanation: "十五五时期的“三新事业布局”是：“1+9+X”新业务布局、国内区域协同的新网络化布局、赋能汽车产业“走出去”的新国际化布局。" },
    { no: 6, type: "single", title: "以下哪一项不包含在中汽中心战略目标中？", options: [{ id: "A", text: "成为政府最认可的产业智库" }, { id: "B", text: "成为行业最尊重的合作伙伴" }, { id: "C", text: "成为国际最具影响力的检测机构" }, { id: "D", text: "成为员工最自豪的事业平台" }], correctOptions: ["C"], explanation: "C选项中“四个最”的战略目标应该是：成为公众最信赖的权威机构" },
    { no: 7, type: "single", title: "中汽中心“十五五”国内区域网络化布局中，集团总部位于哪个区域？", options: [{ id: "A", text: "京津冀" }, { id: "B", text: "长三角" }, { id: "C", text: "粤港澳大湾区" }, { id: "D", text: "成渝地区" }], correctOptions: ["A"] },
    { no: 8, type: "single", title: "中汽中心“十五五”国际化布局中，哪个区域的定位是“打造提升中汽中心国际影响力的标杆工程”？", options: [{ id: "A", text: "日韩" }, { id: "B", text: "欧洲" }, { id: "C", text: "中亚" }, { id: "D", text: "东南亚" }], correctOptions: ["B"] },
    { no: 9, type: "single", title: "下列关于十五五期间的发展目标的表述错误的是：", options: [{ id: "A", text: "高标准担当战略使命，实现核心功能系统性增强" }, { id: "B", text: "高质量推动价值创造，实现国际化布局标杆树立" }, { id: "C", text: "高水平强化创新驱动，实现内涵式发展接续有力" }, { id: "D", text: "高效能深化改革焕新，实现现代化治企科学高效" }], correctOptions: ["B"], explanation: "B选项中，十五五期间的发展目标应该是：高质量推动价值创造，实现核心竞争力跃迁提升" },
    ...
    { no: 11, type: "multiple", title: "中汽中心“十五五”的战新业务群包含以下哪些？", options: [{ id: "A", text: "新能源汽车业务群" }, { id: "B", text: "智能网联汽车业务群" }, { id: "C", text: "低空经济业务群" }, { id: "D", text: "人工智能业务群" }], correctOptions: ["A", "B", "C", "D"], explanation: "人工智能业务群" },
