...
export const PUBLIC_ACTIVITY_DATA = {
  ...
  questions: [
    ...
    { no: 5, type: "single", title: "下列不属于十五五期间的发展布局的有：", options: [{ id: "A", text: "“1+9+X”新业务布局" }, { id: "B", text: "“一体三基四协同”新业务布局" }, { id: "C", text: "国内区域协同的新网络化布局" }, { id: "D", text: "赋能汽车产业走出去的新国际化布局" }], correctOptions: ["B"], explanation: "“1+9+X”新业务布局" },
    { no: 6, type: "single", title: "以下哪一项不包含在中汽中心战略目标中？", options: [{ id: "A", text: "成为政府最认可的产业智库" }, { id: "B", text: "成为行业最尊重的合作伙伴" }, { id: "C", text: "成为国际最具影响力的检测机构" }, { id: "D", text: "成为员工最自豪的事业平台" }], correctOptions: ["C"], explanation: "成为公众最信赖的权威机构" },
    ...
    { no: 9, type: "single", title: "下列关于十五五期间的发展目标的表述错误的是：", options: [{ id: "A", text: "高标准担当战略使命，实现核心功能系统性增强" }, { id: "B", text: "高质量推动价值创造，实现国际化布局标杆树立" }, { id: "C", text: "高水平强化创新驱动，实现内涵式发展接续有力" }, { id: "D", text: "高效能深化改革焕新，实现现代化治企科学高效" }], correctOptions: ["B"], explanation: "高质量推动价值创造，实现核心竞争力跃迁提升" },
    ...
    { no: 11, type: "multiple", title: "中汽中心“十五五”的战新业务群包含以下哪些？", options: [{ id: "A", text: "新能源汽车业务群" }, { id: "B", text: "智能网联汽车业务群" }, { id: "C", text: "低空经济业务群" }, { id: "D", text: "具身智能业务群" }], correctOptions: ["A", "B", "C"], explanation: "人工智能业务群" },
